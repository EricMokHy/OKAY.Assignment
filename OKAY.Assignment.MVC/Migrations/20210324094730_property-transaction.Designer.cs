...
namespace OKAY.Assignment.MVC.Migrations
{
    ...
    [Migration("20210324094730_property-transaction")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OKAY.Assignment.MVC.Entities.Property", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OKAY.Assignment.MVC.Entities.Transaction", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OKAY.Assignment.MVC.Entities.Property", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.ApplicationUser", "User")
                        .WithMany("Properties")
                        .HasForeignKey("userId")
                        .HasConstraintName("FK_Properties_ASPNetUsers_Userid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OKAY.Assignment.MVC.Entities.Transaction", b =>
                {
                    b.HasOne("OKAY.Assignment.MVC.Entities.Property", "Property")
                        .WithMany("Transactions")
                        .HasForeignKey("propertyId")
                        .HasConstraintName("FK_Transactions_Properties_PropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
